...
class SubmarineDebug {
    /**
     * The current submarine instance being debugged.
     * @type {Submarine}
     */
    ...
    /**
     * The GUI instance for debugging purposes.
     * @type {GUI}
     */
    private debugGUI: GUI;

    /**
     * A list of GUI folders for organizing debug controls.
     * @type {GUI[]}
     */
    private folders: GUI[];
    ...
    */
    ...
    initSelectSubmarineControl() {
        ...
        this.debugGUI.add(submarineOptions, 'type', [SubmarineType.Ohio, SubmarineType.Typhoon])
            .name("Select Submarine").onChange((type: any) => {
    ...
    private initDebugGUI() {
        ...
        submarineVariablesFolder
            ...
            .listen(true)
            .onChange((value: any) => { submarineVariables.setCurrentTotalWaterMass(value) })
        submarineVariablesFolder
            ...
            .listen(true)
            .onChange((value: any) => { submarineVariables.setCurrentWaterMassFrontTank(value) })
        submarineVariablesFolder
            ...
            .max(submarineConstants.getBallastTankCapacity() / 2)
            .listen(true)
            .onChange((value: any) => { submarineVariables.setCurrentWaterMassBackTank(value) })
        submarineVariablesFolder
